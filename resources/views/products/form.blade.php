<div class="form-grid">
    ...
    @if(! empty($product?->image_url))
        <div class="span-2"><img src="{{ $product->image_url }}" alt="{{ $product->name }}" style="width:96px;height:96px;object-fit:cover;border:1px solid var(--line);border-radius:8px;"></div>
    @endif
