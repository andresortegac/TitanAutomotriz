...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; } body { margin:0; font-family:Arial, Helvetica, sans-serif; background:var(--bg); color:var(--ink); }
        ...
        .municipality-field { grid-column:span 2; } .municipality-results { grid-column:span 2; max-height:240px; overflow-y:auto; border:1px solid var(--line); border-radius:6px; background:#fff; box-shadow:0 8px 18px rgba(15,23,42,.1); } .municipality-option { display:block; width:100%; padding:10px 11px; border:0; border-bottom:1px solid var(--line); background:#fff; color:var(--ink); text-align:left; font:inherit; cursor:pointer; } .municipality-option:last-child { border-bottom:0; } .municipality-option:hover, .municipality-option:focus { background:#fef2f2; outline:0; }
